...
class MainActivity : AppCompatActivity() {
    ...
    private var profileImageUrl = "https://upload.wikimedia.org/wikipedia/commons/5/57/Windah_Basudara_20_Jan_2021.jpg"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profileCircleImageView = navView.getHeaderView(0).findViewById(R.id.namaaa)
        Glide.with(this)
